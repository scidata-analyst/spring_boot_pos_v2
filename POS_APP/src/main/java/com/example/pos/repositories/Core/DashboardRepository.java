 ...
 * <p>
 * Provides full CRUD operations for Dashboard using JpaRepository.
...
public interface DashboardRepository extends JpaRepository<Dashboard, Long> {
     ...
     * @return Optional containing Dashboard if found
     */
    default Optional<Dashboard> get(Long id) {
        return findById(id);
    }
     ...
     */
    default Dashboard saveEntity(Dashboard entity) {
        return save(entity);
    }
