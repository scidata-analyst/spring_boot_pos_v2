...
const PAGE_MAP = {
  'dashboard':        { file: 'index.html',               title: 'Dashboard',                  parent: null },
  'pos-terminal':     { file: 'pages/pos-terminal.html',  title: 'POS Terminal',               parent: null },
  // Users & Roles
  'cashiers':         { file: 'pages/cashiers.html',      title: 'Cashier Accounts',           parent: 'users' },
  'roles':            { file: 'pages/roles.html',         title: 'Roles & Permissions',        parent: 'users' },
  'activity-log':     { file: 'pages/activity-log.html',  title: 'Activity Log',               parent: 'users' },
  // Products
  'catalog':          { file: 'pages/catalog.html',       title: 'Product Catalog',            parent: 'products' },
  'categories':       { file: 'pages/categories.html',    title: 'Categories',                 parent: 'products' },
  'barcodes':         { file: 'pages/barcodes.html',      title: 'Barcode / SKU',              parent: 'products' },
  'batch-expiry':     { file: 'pages/batch-expiry.html',  title: 'Batch & Expiry',             parent: 'products' },
  'stock-movement':   { file: 'pages/stock-movement.html',title: 'Stock In / Out',             parent: 'products' },
  // Sales & Billing
  'transactions':     { file: 'pages/transactions.html',  title: 'Transactions',               parent: 'sales' },
  'invoices':         { file: 'pages/invoices.html',      title: 'Invoices / Receipts',        parent: 'sales' },
  'held-orders':      { file: 'pages/held-orders.html',   title: 'Held Orders',                parent: 'sales' },
  'returns':          { file: 'pages/returns.html',       title: 'Returns & Refunds',          parent: 'sales' },
  // Customers
  'customers':        { file: 'pages/customers.html',     title: 'Customer Directory',         parent: 'customers' },
  'purchase-history': { file: 'pages/purchase-history.html', title: 'Purchase History',        parent: 'customers' },
  'loyalty-points':   { file: 'pages/loyalty-points.html',title: 'Loyalty Points',             parent: 'customers' },
  'memberships':      { file: 'pages/memberships.html',   title: 'Memberships / VIP',          parent: 'customers' },
  // Suppliers
  'suppliers':        { file: 'pages/suppliers.html',     title: 'Supplier Directory',         parent: 'suppliers' },
  'purchase-orders':  { file: 'pages/purchase-orders.html',title: 'Purchase Orders',           parent: 'suppliers' },
  'restock-alerts':   { file: 'pages/restock-alerts.html',title: 'Restock Alerts',             parent: 'suppliers' },
  'supplier-payments':{ file: 'pages/supplier-payments.html', title: 'Supplier Payments',      parent: 'suppliers' },
  // Payment & Accounting
  'cash-register':    { file: 'pages/cash-register.html', title: 'Cash Register',              parent: 'payment' },
  'reconciliation':   { file: 'pages/reconciliation.html',title: 'Reconciliation',             parent: 'payment' },
  'ap-ar':            { file: 'pages/ap-ar.html',         title: 'AP / AR',                    parent: 'payment' },
  'tax-reports':      { file: 'pages/tax-reports.html',   title: 'Tax Reports',                parent: 'payment' },
  // Reports
  'sales-report':     { file: 'pages/sales-report.html',  title: 'Sales Reports',              parent: 'reports' },
  'stock-report':     { file: 'pages/stock-report.html',  title: 'Stock Reports',              parent: 'reports' },
  'pl-report':        { file: 'pages/pl-report.html',     title: 'Profit & Loss',              parent: 'reports' },
  'custom-report':    { file: 'pages/custom-report.html', title: 'Custom Builder',             parent: 'reports' },
  // Promotions
  'offers':           { file: 'pages/offers.html',        title: 'Offers & Combos',            parent: 'promos' },
  'coupons':          { file: 'pages/coupons.html',       title: 'Coupon Codes',               parent: 'promos' },
  'happy-hour':       { file: 'pages/happy-hour.html',    title: 'Happy Hour',                 parent: 'promos' },
  // Loyalty
  'points-config':    { file: 'pages/points-config.html', title: 'Points Config',              parent: 'loyalty' },
  'tier-management':  { file: 'pages/tier-management.html',title: 'Tier Management',           parent: 'loyalty' },
  'retention':        { file: 'pages/retention.html',     title: 'Retention Tracking',         parent: 'loyalty' },
  // Hardware
  'devices':          { file: 'pages/devices.html',       title: 'Devices & Printers',         parent: 'hardware' },
  'cash-drawer':      { file: 'pages/cash-drawer.html',   title: 'Cash Drawer',                parent: 'hardware' },
  'qr-mobile':        { file: 'pages/qr-mobile.html',     title: 'QR / Mobile Pay',            parent: 'hardware' },
};
...
function buildSidebar(activePage) {
  ...
  <nav id="sidebar">
    ...
    <div class="sidebar-nav">
      ...
      ${navItem('dashboard', 'bi-grid-fill', 'Dashboard', 'index.html')}
      ${navItem('pos-terminal', 'bi-display', 'POS Terminal', 'pages/pos-terminal.html')}
...
function buildHeader(title) {
  ...
  <header id="header">
    ...
    <div class="header-actions">
      ...
      <div class="h-btn" title="Low Stock Alerts" onclick="navigate('pages/restock-alerts.html')">
        <i class="bi bi-exclamation-triangle"></i><span class="h-badge" style="background:var(--amber)">5</span>
      </div>
      <button class="h-pos-btn" onclick="navigate('pages/pos-terminal.html')">
