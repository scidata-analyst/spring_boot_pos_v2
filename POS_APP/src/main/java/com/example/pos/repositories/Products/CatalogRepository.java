...
/**
 * Repository interface for Catalog entity.
 * <p>
 * Provides full CRUD operations for Catalog using JpaRepository.
...
public interface CatalogRepository extends JpaRepository<Catalog, Long> {
     ...
     * @return Optional containing Catalog if found
     */
    default Optional<Catalog> get(Long id) {
        return findById(id);
    }

    /**
     * Save or update a Catalog.
     * Corresponds to create() or update() in Controller/Service.
     * @param entity Entity object to save
     * @return Saved Catalog
     */
    default Catalog saveEntity(Catalog entity) {
        return save(entity);
    }
